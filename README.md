...
A modern, interactive personnel management dashboard developed as part of a coding school assignment. This application allows users to view employee lists, manage company structures, and edit data through a clean, responsive interface.

## 🔗 Project Links
- **Live Demo:** https://krychvas.github.io/employee-dashboard/
- **Repository:** https://github.com/KrychVas/employee-dashboard
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/KrychVas/employee-dashboard.git](https://github.com/KrychVas/employee-dashboard.git)
